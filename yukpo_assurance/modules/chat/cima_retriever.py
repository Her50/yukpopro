...
def rechercher_articles(question: str) -> str:
    ...
    footer = (
        ...
        "4. INTERDIT ABSOLU : N'invente JAMAIS le texte d'un article, ne complete JAMAIS\n"
        "   un article avec tes connaissances générales. Si le texte est court, reproduis-le\n"
        "   tel quel et indique '[TEXTE INTEGRAL DISPONIBLE]' ou '[EXTRAIT]' selon le cas.\n"
        "5. Si un article n'est pas dans la base, indique EXPLICITEMENT :\n"
        "   'Cet article n'est pas dans notre base documentaire — consultez le texte officiel\n"
        "   CIMA disponible auprès de la CRCA ou sur le site officiel de la CIMA.'\n"
        "   NE réponds PAS sur tes connaissances générales pour le texte d'un article.\n"
        "6. Adapte le niveau de l'analyse au profil de l'utilisateur.\n"
        "======================================================"
    )
