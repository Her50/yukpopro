...
async def _generer_titre_document(
    ...
    prompt = (
        "Tu génères un TITRE court, intelligent et fidèle au CONTENU du document.\n\n"
        f"Type de document souhaité : {libelle_type}\n"
        f"Demande brute de l'utilisateur : « {message[:600]} »\n"
        + (f"\nCONTENU RÉEL DU DOCUMENT (extrait des fichiers joints ou contexte) :\n"
           f"« {ctx_extrait} »\n" if ctx_extrait else "")
        + "\nRÈGLES IMPÉRATIVES :\n"
        "1. Si un CONTENU RÉEL est fourni ci-dessus, le titre DOIT refléter ce contenu "
        "(date, sujet, organisation, événement réel) — pas la demande brute.\n"
        "2. Ne JAMAIS recopier la phrase de l'utilisateur ni inclure d'amorce verbale "
        "(« Génère », « Rédige », « Fais-moi », « Donne-moi », « Compte-rendu de ces "
        "captures »…). Reformule en libellé de document fini.\n"
        "3. 4 à 12 mots, français, casse normale (1re lettre majuscule, reste minuscule "
        "sauf noms propres). Pas de guillemets, pas de ponctuation finale.\n"
        "4. Inclure les éléments factuels distinctifs trouvés dans le contenu : DATE "
        "(jour/mois/année), NOM d'organisation/famille/projet, PÉRIODE, ÉVÉNEMENT.\n"
        "5. Adapté au registre : un compte-rendu de réunion familiale ne s'appelle "
        "pas « Rapport d'analyse » ; un faire-part ne s'appelle pas « Note de synthèse ».\n\n"
        "EXEMPLES :\n"
        "  Demande : « Rédige-moi un rapport d'analyse crédit pour la PME ABC »\n"
        "  → Rapport d'analyse crédit — PME ABC\n\n"
        "  Demande : « génère le rapport word d'une réunion de famille de ces captures »\n"
        "  Contenu : « Réunion du 10 mai 2026 — ordre du jour : prière, nouvelles, finances… »\n"
        "  → Compte-rendu de la réunion de famille du 10 mai 2026\n\n"
        "  Demande : « fais-moi un compte-rendu de l'AG »\n"
        "  Contenu : « Assemblée Générale tontine Solidarité du 15 mars 2026, Dorcas… »\n"
        "  → Compte-rendu de l'AG Tontine Solidarité — 15 mars 2026\n\n"
        "  Demande : « rédige un faire-part pour la naissance de mon fils »\n"
        "  Contenu : « Naissance de Mathieu, fils de Jean et Marie, 12 avril 2026 »\n"
        "  → Faire-part de naissance de Mathieu — avril 2026\n\n"
        "Réponds UNIQUEMENT par le titre final, rien d'autre, aucune explication."
    )
